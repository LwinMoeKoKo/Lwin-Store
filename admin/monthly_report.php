...
$fromDate = date('Y-m-d',strtotime($nowDate . '+1 day'));
$toDate = date('Y-m-d',strtotime($nowDate . '-1 month'));

$monthlyReport = $table1->monthlyOrderReport($fromDate, $toDate);
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col">
              ...
              <h1 class="my-3">monthly Report Table</h1>
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Orders in a month <span class="right badge badge-danger ms-2"><?= count($monthlyReport) ?></span>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table class="table table-striped" id="dataTable">
                    ...
                    <tbody>
                      <?php $i = 1;
                      foreach($monthlyReport as $order) : ?>
                        <tr>
                          <td><?= $i ?></td>

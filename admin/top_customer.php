        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col">
              ...
              <h1 class="my-3">Top Customer Table</h1>
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Customer shop more than $200 <span class="right badge badge-danger ms-2"><?= count($topBuyer) ?></span>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

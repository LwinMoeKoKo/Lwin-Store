...
$toDate =  date("Y-m-d",strtotime($nowDate. '-7 day'));


$weeklyReport = $table1->weeklyOrderReport($fromDate, $toDate);
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col">
              ...
              <h1 class="my-3">Weekly Report Table</h1>
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Orders in a week <span class="right badge badge-danger ms-2"><?= count($weeklyReport) ?></span>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

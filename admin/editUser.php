...
if (($_POST)) {
  if (!($_POST['name']) || !($_POST['email'])) {
    ...
    if (!$password) {
      ...
      HTTP::redirect("admin/usersTable.php", "edit=true");
    }
  }
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="usersTable.php" class="nav-link">
                    <i class="nav-icon fas fa-users"></i>
                    <p>All Admins & Users
                      <span class="badge badge-danger right"><?= count($allUser) ?></span>
                    </p>
                  </a>
                <li class="nav-item">
                    ...
                    <div class="card-body  bg-gradient">
                      <form action="editUser.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <?php endif ?>
                          <input type="text" name="name" class="form-control" value="<?= $table1->h($user->name) ?>">
                        </div>
                        <div class="mb-3">
                          ...
                          <?php endif ?>
                          <input type="text" name="email" class="form-control" value="<?= $table1->h($user->email)  ?>">
                        </div>
                        <div class="mb-3">

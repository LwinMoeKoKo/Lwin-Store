...
$orderDetails = $table1->getOrderDetail($id);
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <h1 class="my-3">Orders Details</h1>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped" id="table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($orderDetails as $orderDetail) : ?>
                                                <tr>
                                                    <td><?= $i ?> </td>
                                                    <td><?= $table->h($orderDetail->Pname) ?></td>
                                                    <td><?= $table->h($orderDetail->quantity) ?></td>
                                                    <td><?= $table->h(date("Y-m-d"),strtotime($orderDetail->order_date)) ?></td>
                                                </tr>
                                                <?php $i++ ?>
                                            <?php endforeach ?>    
                                        </tbody>
                                    ...
                                    <div class="float-right">
                                        <a href="ordersTable.php" class="btn btn-outline-success">Back</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
